...
def get_prompt_template(system_prompt=system_prompt, promptTemplate_type=None, history=False):
    if promptTemplate_type == "llama":
        ...
        if history:
            instruction = """
            Context in the following language: German: {history} \n German {context}
            User question in the following language : German :{question}
            ...
            instruction = """
            Context in the following language: German :{context}
            User question in the following language : German :{question}
            Answer in the following language: German """
